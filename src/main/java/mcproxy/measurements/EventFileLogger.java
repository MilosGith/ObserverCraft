...
public class EventFileLogger extends EventLogger {
    ...
    public EventFileLogger(File file, ObserverServer server) {
        super(server);
        this.file = file;
    }
    ...
    public void init() throws IOException {
        ...
        this.writer.println("timestamp\tkey\tvalue\tplayercount");
    ...
    @Override
    public synchronized void log(String key, String value, int playercount) {
        try {
            logEntries.put(System.currentTimeMillis() + "\t" + key + "\t" + value + "\t" + playercount);
